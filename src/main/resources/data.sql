...
INSERT IGNORE INTO restaurants (restaurant_id, category_name, name, image_name, restaurant_description, lowest_price, highest_price, opening_time, closing_time, phone_number, address, regular_holiday, capacity) VALUES (3, '味噌かつ', '矢田かつ', 'yadakatsu.jpg', '「矢田かつ」は、ナゴヤドーム前矢田駅から徒歩6分ほどの場所にある定食屋さんです。', 1000, 6000, '10:00:00', '22:00:00', '090-0000-0000', '名古屋', '毎週金曜日', 50);
INSERT IGNORE INTO restaurants (restaurant_id, category_name, name, image_name, restaurant_description, lowest_price, highest_price, opening_time, closing_time, phone_number, address, regular_holiday, capacity) VALUES (4, '洋食', 'ちかさんの手料理', 'chika.jpg', '「ちかさんの手料理」は、神宮前駅から徒歩3分ほどの場所にあるレストランです。', 1000, 6000, '10:00:00', '22:00:00', '090-0000-0000', '名古屋', '毎週金曜日', 50);
INSERT IGNORE INTO restaurants (restaurant_id, category_name, name, image_name, restaurant_description, lowest_price, highest_price, opening_time, closing_time, phone_number, address, regular_holiday, capacity) VALUES (5, '味噌かつ', '味処 叶', 'kanau.jpg', '「味処 叶」は、矢場町駅より徒歩6分ほどの場所にある定食屋さんです。。', 1000, 6000, '10:00:00', '22:00:00', '090-0000-0000','名古屋', '毎週金曜日', 50);
INSERT IGNORE INTO restaurants (restaurant_id, category_name, name, image_name, restaurant_description, lowest_price, highest_price, opening_time, closing_time, phone_number, address, regular_holiday, capacity) VALUES (6, 'とんかつ', 'とん八', 'tonpati.jpg', '「とん八」は、鶴舞駅から徒歩4分ほどの場所にあるとんかつ屋さんです。', 1000, 6000, '10:00:00', '22:00:00', '090-0000-0000', '名古屋', '毎週金曜日', 50);
INSERT IGNORE INTO restaurants (restaurant_id, category_name, name, image_name, restaurant_description, lowest_price, highest_price, opening_time, closing_time, phone_number, address, regular_holiday, capacity) VALUES (7, 'とんかつ', 'MOBU', 'mobu.jpg', '「MOBU」は、名古屋競馬場前駅から徒歩12分ほどの場所にあるとんかつ屋さんです。', 1000, 6000, '10:00:00', '22:00:00', '090-0000-0000', '名古屋', '毎週金曜日', 50);
INSERT IGNORE INTO restaurants (restaurant_id, category_name, name, image_name, restaurant_description, lowest_price, highest_price, opening_time, closing_time, phone_number, address, regular_holiday, capacity) VALUES (8, '定食', '酒津屋 中店', 'sakatsu.jpg', '「酒津屋 中店」は栄駅から歩いて1分ほど、森の地下街、南一番街にある定食屋さんです。', 1000, 6000, '10:00:00', '22:00:00', '090-0000-0000','名古屋', '毎週金曜日', 50);
INSERT IGNORE INTO restaurants (restaurant_id, category_name, name, image_name, restaurant_description, lowest_price, highest_price, opening_time, closing_time, phone_number, address, regular_holiday, capacity) VALUES (9, 'ひつまぶし', 'うな富士', 'unafuzi.jpg', '「うな富士」は、鶴舞駅から徒歩10分ほどの場所にあるうなぎ料理店です。', 1000, 6000, '10:00:00', '22:00:00', '090-0000-0000','名古屋', '毎週金曜日', 50);
INSERT IGNORE INTO restaurants (restaurant_id, category_name, name, image_name, restaurant_description, lowest_price, highest_price, opening_time, closing_time, phone_number, address, regular_holiday, capacity) VALUES (10, 'うなぎ料理', 'イチビキ', 'ithibiki.jpg', '「イチビキ」は、名古屋駅サンロード6番出口から徒歩8分ほどの場所にあるうなぎ料理店です。', 1000, 6000, '10:00:00', '22:00:00', '090-0000-0000','名古屋', '毎週金曜日', 50);
INSERT IGNORE INTO restaurants (restaurant_id, category_name, name, image_name, restaurant_description, lowest_price, highest_price, opening_time, closing_time, phone_number, address, regular_holiday, capacity) VALUES (11, 'うどん', 'めん専門店 味良', 'aziryou.jpg', '「めん専門店 味良」は、黒川駅から車で7分ほどの場所にあるうどん屋さんです。', 1000, 6000, '10:00:00', '22:00:00', '090-0000-0000','名古屋', '毎週金曜日', 50);
INSERT IGNORE INTO restaurants (restaurant_id, category_name, name, image_name, restaurant_description, lowest_price, highest_price, opening_time, closing_time, phone_number, address, regular_holiday, capacity) VALUES (12, '喫茶店', 'コーヒーショップ カコ 花車本店', 'hanaguruma.jpg', '「コーヒーショップ カコ 花車本店」は、国際センター駅から徒歩3分ほどの場所にある喫茶店です。', 1000, 6000, '10:00:00', '22:00:00', '090-0000-0000', '名古屋', '毎週金曜日', 50);
INSERT IGNORE INTO restaurants (restaurant_id, category_name, name, image_name, restaurant_description, lowest_price, highest_price, opening_time, closing_time, phone_number, address, regular_holiday, capacity) VALUES (13, '郷土料理', '名古屋名物 名古屋めし食堂 丸八', 'maruhachi.jpg', '「名古屋名物 名古屋めし食堂 丸八」は、名古屋駅から徒歩6分ほどの場所にある郷土料理店です。', 1000, 6000, '10:00:00', '22:00:00', '090-0000-0000', '名古屋', '毎週金曜日', 50);

--categoriesテーブル--
INSERT IGNORE INTO categories (id, category_name) VALUES (1, 'うなぎ料理');
INSERT IGNORE INTO categories (id, category_name) VALUES (2, '和風料理');
INSERT IGNORE INTO categories (id, category_name) VALUES (3, '味噌かつ');
INSERT IGNORE INTO categories (id, category_name) VALUES (4, '洋食');
INSERT IGNORE INTO categories (id, category_name) VALUES (5, '定食');
INSERT IGNORE INTO categories (id, category_name) VALUES (6, 'ひつまぶし');
...
INSERT IGNORE INTO reviews (id, user_id, restaurant_id, sentense, score) VALUES (2, 2, 2, 'まずかったです', 2);
INSERT IGNORE INTO reviews (id, user_id, restaurant_id, sentense, score) VALUES (3, 3, 3, '微妙', 3);
INSERT IGNORE INTO reviews (id, user_id, restaurant_id, sentense, score) VALUES (4, 4, 4, '返金レベル', 4);
INSERT IGNORE INTO reviews (id, user_id, restaurant_id, sentense, score) VALUES (5, 5, 5, '最高！', 5);
INSERT IGNORE INTO reviews (id, user_id, restaurant_id, sentense, score) VALUES (6, 6, 6, 'よかったです', 4);
INSERT IGNORE INTO reviews (id, user_id, restaurant_id, sentense, score) VALUES (7, 7, 7, '雰囲気も味もよかった', 5);
INSERT IGNORE INTO reviews (id, user_id, restaurant_id, sentense, score) VALUES (8, 8, 8, '食中毒になった', 1);
INSERT IGNORE INTO reviews (id, user_id, restaurant_id, sentense, score) VALUES (9, 9, 9, 'また行きたいです', 3);
INSERT IGNORE INTO reviews (id, user_id, restaurant_id, sentense, score) VALUES (10, 10, 10, 'うーん', 2);
...
INSERT IGNORE INTO users (id, role_id, name, kana, email, password, address, phone_number,enabled) VALUES (6, 1, '無料太郎', 'ムリョウタロウ', 'muryo@sample.com', '$2a$10$2JNjTwZBwo7fprL2X4sv.OEKqxnVtsVQvuXDkI8xVGix.U3W5B7CO', '厚木市西', '090-0000-0000',true);
INSERT IGNORE INTO users (id, role_id, name, kana, email, password, address, phone_number,enabled) VALUES (7, 3, '管理太郎', 'カンリタロウ', 'kanri@sample.com', '$2a$10$2JNjTwZBwo7fprL2X4sv.OEKqxnVtsVQvuXDkI8xVGix.U3W5B7CO', '厚木市西', '090-0000-0000',true);
INSERT IGNORE INTO users (id, role_id, name, kana, email, password, address, phone_number,enabled) VALUES (10, 2, '有料太郎', 'ユウリョウタロウ', 'yuryo@sample.com', '$2a$10$2JNjTwZBwo7fprL2X4sv.OEKqxnVtsVQvuXDkI8xVGix.U3W5B7CO', '厚木市西', '090-0000-0000',true);
